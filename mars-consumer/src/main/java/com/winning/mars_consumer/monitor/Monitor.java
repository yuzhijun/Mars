...
public class Monitor {
    ...
    public void startMonitor(Context context){
        ...
        mCompositeDisposable.add(mars.getModule(Crash.class).subject().subscribe(new Consumer<List<CrashBean>>() {
            @Override
            public void accept(List<CrashBean> crashBeans) throws Exception {
                mRepos.setCrashBeans(crashBeans);
            }
        }));
